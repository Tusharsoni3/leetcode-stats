document.addEventListener("DOMContentLoaded", function() {
    ...
    function displayUserData(parsedData) {
        if (!parsedData || !parsedData.data || !parsedData.data.matchedUser) {
            statsContainer.innerHTML = "<p>Failed to fetch user data.</p>";
            return;
        }
        ...
        console.log("Cards Data:", cardsData);  // Log the card data

        // Check if cardStatsContainer exists and update it
        if (cardStatsContainer) {
            ...
            console.error("cardStatsContainer not found");
        }
    }
